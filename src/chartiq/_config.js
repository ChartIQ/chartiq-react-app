...
export function getDefaultConfig() {
	return {
		...
		drawingTools: [
			...
			{ tool: 'channel', group: 'line', label: 'Channel' },
			{ tool: 'continuous', group: 'line', label: 'Continuous' },
			{ tool: 'crossline', group: 'line', label: 'Crossline' },
			{ tool: 'freeform', group: 'line', label: 'Doodle' },
			{ tool: 'ellipse', group: 'marking', label: 'Ellipse' },
			...
			{ tool: 'horizontal', group: 'line', label: 'Horizontal' },
			{ tool: 'lines', group: 'line', label: 'Line' },
			{ tool: 'pitchfork', group: 'technicals', label: 'Pitchfork' },
			{ tool: 'quadrant', group: 'statistics', label: 'Quadrant Lines' },
			{ tool: 'ray', group: 'line', label: 'Ray' },
			{ tool: 'rectangle', group: 'marking', label: 'Rectangle' },
			{ tool: 'regression', group: 'statistics', label: 'Regression Line' },
			{ tool: 'segment', group: 'line', label: 'Segment' },
			{ tool: 'arrow', group: 'marking', label: 'Arrow' },
			{ tool: 'check', group: 'marking', label: 'Check' },
			{ tool: 'xcross', group: 'marking', label: 'Cross' },
			{ tool: 'focusarrow', group: 'marking', label: 'Focus' },
			{ tool: 'heart', group: 'marking', label: 'Heart' },
			{ tool: 'star', group: 'marking', label: 'Star' },
			...
			{ tool: 'vertical', group: 'line', label: 'Vertical' }
		],
