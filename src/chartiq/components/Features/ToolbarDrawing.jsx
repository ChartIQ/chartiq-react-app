		...
		return (
			<cq-toolbar cq-drawing-edit="none" ref={this.toolbar}>
				...
				<cq-toolbar-settings>
					...
					<template cq-cvp-controller="true">{cvpTemplate}</template>
					...
					<cq-annotation cq-section="true">
						...
						<cq-menu class="ciq-select">
							...
							<cq-menu-dropdown class="ciq-font-family">
								...
								<cq-item stxtap="setFontFamily('Times New Roman')">
									Times New Roman
								</cq-item>
							</cq-menu-dropdown>
						</cq-menu>
				...
				<cq-measure>
					<span className="mMeasure"></span>
				</cq-measure>
				<cq-undo-section className="ciq-drawing-edit-hidden">
					<cq-undo class="ciq-btn" ref={this.undoButton}>
						Undo
					</cq-undo>
					<cq-redo class="ciq-btn" ref={this.redoButton}>
						Redo
					</cq-redo>
				</cq-undo-section>
			</cq-toolbar>
