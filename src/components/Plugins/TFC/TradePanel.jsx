			...
			<div className="stx-panel-side stx-trade-panel">
				<div className="stx-wrapper stx-trade-nav">
					...
					<ul className="stx-account">
						<li><span>Cash</span> <span className="tfc-current-cash"></span></li>
						<li><span>Funds Available</span> <span className="tfc-current-funds"></span></li>
						<li><span>Position</span> <span className="tfc-current-position"></span></li>
					</ul>
					<a className="stx-trade-ticket-toggle open" onClick={this.context.resize}>Expand/Collapse</a>
				</div>
				...
				<div className="stx-panel-module stx-trade-positions" style={{position:"relative"}}>
					<div className="stx-head-bar">
					<h4><span className="stx-ico"></span>Positions</h4>
					<div className="stx-btn click stx-close-all">Close All</div>
					<ul className="tfc-positions-view holder">
						<li className="tfc-positions-view summary active"><i className="fa"></i></li>
						<li className="tfc-positions-view lots"><i className="fa"></i></li>
						<li className="tfc-positions-view performance"><i className="fa"></i></li>
						<li className="tfc-positions-view maintenance"><i className="fa">/</i></li>
					</ul>
					</div>

					<div className="stx-section stx-holder">
					<table cellSpacing="0" cellPadding="0" border="0" className="stx-current-position">
					<thead>
					...
					<th scope="col" className="tfc-trade-date">Date</th>
					<th scope="col">QTY</th>
					<th scope="col">Basis</th>
					<th scope="col">G/L</th>
					<th scope="col">% G/L</th>
					...
					<th scope="col" className="tfc-col-qty">QTY</th>
					<th scope="col">Basis</th>
					<th scope="col" className="tfc-trade-actions" colSpan="S">Protections</th>
					<th scope="col"></th>
					</tr>
					</thead>
					<tbody>
				...
				<div className="stx-panel-module stx-trade-current" style={{position:"relative"}}>
					<div className="stx-head-bar">
					<h4><span className="stx-ico"></span>Open Orders</h4>
					</div>
					<div className="stx-section stx-holder">
						<table cellSpacing="0" cellPadding="0" border="0" className="stx-current-orders">
						<tbody>
						</tbody>
						</table>
					</div>
				</div>
				<a className="stx-trade-ticket-toggle close" onClick={this.context.resize}>Expand/Collapse</a>
				</div>
			</div>
			</React.Fragment>
		)
