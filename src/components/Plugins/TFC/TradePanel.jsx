...
export default class TradePanel extends React.Component {
	...
	render() {
		return (
			<React.Fragment>
			<div className="stx-panel-side stx-trade-panel active">
			<div className="stx-wrapper stx-trade-nav">
				...
				<a className="stx-trade-ticket-toggle open">Expand/Collapse</a>
			</div>
			...
			<li className="tfc-positions-view lots"><i class="fa"></i></li>
			...
			<a className="stx-trade-ticket-toggle close">Expand/Collapse</a>
			</div>
		*/}
			</div>
			</React.Fragment>
